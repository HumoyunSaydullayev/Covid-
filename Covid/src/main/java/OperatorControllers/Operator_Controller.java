...
public class Operator_Controller implements Initializable {
    public Label undo;
    public Label menu;
    public StackPane ContentArea;
    public Button Myprofile;
    public Button vaksina_jarayoni;
    ...
    public void Myprofile(ActionEvent actionEvent) throws IOException, ClassNotFoundException {
        vaksina_jarayoni.setStyle("-fx-background-color: transparent; -fx-background-radius: 20; -fx-border-radius: 20; -fx-border-color: #00ff22; -fx-border-width: 2 0 2 0;");
        Myprofile.setStyle("-fx-background-color: #00ff22; -fx-background-radius: 20; -fx-border-radius: 20; -fx-border-color: #00ff22; -fx-border-width: 2 0 2 0;");
        ...
        FXMLLoader loader=new FXMLLoader(HelloApplication.class.getResource("OperatorFXmls/MyProfile.fxml"));
        Parent root = loader.load();
        MyProfileController ctrl = loader.getController();
        ctrl.setId(getId());
        ctrl.about();
    ...
    public void Vaksinalar(ActionEvent actionEvent) throws IOException {
        vaksina_jarayoni.setStyle("-fx-background-color: transparent; -fx-background-radius: 20; -fx-border-radius: 20; -fx-border-color: #00ff22; -fx-border-width: 2 0 2 0;");
        Myprofile.setStyle("-fx-background-color: transparent; -fx-background-radius: 20; -fx-border-radius: 20; -fx-border-color: #00ff22; -fx-border-width: 2 0 2 0;");
        ...
        statistika.setStyle("-fx-background-color: transparent; -fx-background-radius: 20; -fx-border-radius: 20; -fx-border-color: #00ff22; -fx-border-width: 2 0 2 0;");
        Parent root=FXMLLoader.load(Objects.requireNonNull(HelloApplication.class.getResource("OperatorFXmls/Vaksinalar_Crud.fxml")));
        ContentArea.getChildren().removeAll();
        ContentArea.getChildren().setAll(root);
    }
    public void Vaksina_jarayoni(ActionEvent actionEvent) throws IOException {
        vaksina_jarayoni.setStyle("-fx-background-color: #00ff22; -fx-background-radius: 20; -fx-border-radius: 20; -fx-border-color: #00ff22; -fx-border-width: 2 0 2 0;");
        Myprofile.setStyle("-fx-background-color: transparent; -fx-background-radius: 20; -fx-border-radius: 20; -fx-border-color: #00ff22; -fx-border-width: 2 0 2 0;");
        vaksinalar.setStyle("-fx-background-color: transparent; -fx-background-radius: 20; -fx-border-radius: 20; -fx-border-color: #00ff22; -fx-border-width: 2 0 2 0;");
        statistika.setStyle("-fx-background-color: transparent; -fx-background-radius: 20; -fx-border-radius: 20; -fx-border-color: #00ff22; -fx-border-width: 2 0 2 0;");
        FXMLLoader loader=new FXMLLoader(HelloApplication.class.getResource("OperatorFXmls/Jarayon_menu.fxml"));
        Parent root = loader.load();
        JarayonController ctrl = loader.getController();
        ctrl.setId(getId());
        ContentArea.getChildren().removeAll();
        ContentArea.getChildren().setAll(root);
    }
    public void Statistika(ActionEvent actionEvent) throws IOException {
        ...
        ctrl.about();
//        Parent root=FXMLLoader.load(Objects.requireNonNull(HelloApplication.class.getResource("Statistika.fxml")));
        ContentArea.getChildren().removeAll();
        ContentArea.getChildren().setAll(root);
    }
}
